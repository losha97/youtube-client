...
export class SearchResultBlockComponent implements OnInit {
  ...
  constructor(private searchResultService: SearchResultService, private searchResultBlockDisplayService: SearchResultBlockDisplayService, private filterByViewsService: FilterByViewsService, private filterByDateService: FilterByDateService, private filterByTextService: FilterByTextService) {
