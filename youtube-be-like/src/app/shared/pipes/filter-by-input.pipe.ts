...
import { FilterByTextService } from '../../core/services/filter-by-text.service';
...
export class FilterByInputPipe implements PipeTransform {
  ...
  constructor(private filterByTextService: FilterByTextService) {
    this.textSubscription = this.filterByTextService.onToggle().subscribe((value: string) => this.text = value);
  }
